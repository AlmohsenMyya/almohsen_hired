import 'package:almohsen_s_application11/widgets/app_bar/custom_app_bar.dart';import 'package:almohsen_s_application11/widgets/app_bar/appbar_leading_image.dart';import 'package:almohsen_s_application11/widgets/app_bar/appbar_trailing_image.dart';import 'package:almohsen_s_application11/widgets/custom_outlined_button.dart';import 'package:almohsen_s_application11/core/utils/validation_functions.dart';import 'package:almohsen_s_application11/widgets/custom_text_form_field.dart';import 'package:almohsen_s_application11/widgets/custom_elevated_button.dart';import 'package:flutter/material.dart';import 'package:almohsen_s_application11/core/app_export.dart';import 'controller/login_controller.dart';import 'package:almohsen_s_application11/domain/googleauth/google_auth_helper.dart';
// ignore_for_file: must_be_immutable
class LoginScreen extends GetWidget<LoginController> {LoginScreen({Key? key}) : super(key: key);

GlobalKey<FormState> _formKey = GlobalKey<FormState>();

@override Widget build(BuildContext context) { return SafeArea(child: Scaffold(resizeToAvoidBottomInset: false, appBar: _buildAppBar(), body: SizedBox(width: SizeUtils.width, child: SingleChildScrollView(padding: EdgeInsets.only(bottom: MediaQuery.of(context).viewInsets.bottom), child: Form(key: _formKey, child: Container(width: double.maxFinite, padding: EdgeInsets.symmetric(horizontal: 24.h, vertical: 31.v), child: Column(children: [Text("msg_hi_welcome_back".tr, style: theme.textTheme.headlineSmall), SizedBox(height: 11.v), Text("msg_lorem_ipsum_dolor".tr, style: CustomTextStyles.titleSmallGray500), SizedBox(height: 31.v), CustomOutlinedButton(text: "msg_continue_with_google".tr, leftIcon: Container(margin: EdgeInsets.only(right: 12.h), child: CustomImageView(imagePath: ImageConstant.imgGooglesymbol1, height: 23.v, width: 24.h)), onPressed: () {onTapContinueWithGoogle();}), SizedBox(height: 16.v), CustomOutlinedButton(text: "msg_continue_with_apple".tr, leftIcon: Container(margin: EdgeInsets.only(right: 12.h), child: CustomImageView(imagePath: ImageConstant.imgIconApple, height: 24.adaptSize, width: 24.adaptSize))), SizedBox(height: 26.v), Padding(padding: EdgeInsets.symmetric(horizontal: 33.h), child: Row(mainAxisAlignment: MainAxisAlignment.center, crossAxisAlignment: CrossAxisAlignment.start, children: [Padding(padding: EdgeInsets.symmetric(vertical: 8.v), child: SizedBox(width: 62.h, child: Divider())), Padding(padding: EdgeInsets.only(left: 12.h), child: Text("msg_or_continue_with".tr, style: CustomTextStyles.titleSmallGray500SemiBold)), Padding(padding: EdgeInsets.symmetric(vertical: 8.v), child: SizedBox(width: 74.h, child: Divider(indent: 12.h)))])), SizedBox(height: 28.v), _buildInputField(), SizedBox(height: 40.v), CustomElevatedButton(text: "msg_continue_with_email".tr, onPressed: () {onTapContinueWithEmail();}), SizedBox(height: 26.v), Padding(padding: EdgeInsets.symmetric(horizontal: 41.h), child: Row(mainAxisAlignment: MainAxisAlignment.center, children: [Padding(padding: EdgeInsets.only(bottom: 1.v), child: Text("msg_don_t_have_an_account".tr, style: CustomTextStyles.titleMediumGray500)), GestureDetector(onTap: () {onTapTxtLargeLabelMedium();}, child: Padding(padding: EdgeInsets.only(left: 2.h), child: Text("lbl_sign_up".tr, style: theme.textTheme.titleMedium)))])), SizedBox(height: 84.v), Container(width: 245.h, margin: EdgeInsets.symmetric(horizontal: 40.h), child: RichText(text: TextSpan(children: [TextSpan(text: "msg_by_signing_up_you2".tr, style: CustomTextStyles.titleSmallffa3a2a7), TextSpan(text: "lbl_terms".tr, style: CustomTextStyles.titleSmallff000000), TextSpan(text: "lbl_and".tr, style: CustomTextStyles.titleSmallffa3a2a7), TextSpan(text: "msg_conditions_of_use".tr, style: CustomTextStyles.titleSmallff000000)]), textAlign: TextAlign.center)), SizedBox(height: 9.v)]))))))); } 
/// Section Widget
...
onTapContinueWithEmail() { Get.toNamed(AppRoutes.enterOtpScreen, ); } 
/// Navigates to the signUpCreateAcountScreen when the action is triggered.
onTapTxtLargeLabelMedium() { Get.toNamed(AppRoutes.signUpCreateAcountScreen, ); } 
 }
